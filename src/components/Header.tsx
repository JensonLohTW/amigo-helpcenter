...
>(function Header({ className, ...props }, ref) {
  ...
  return (
    <motion.div
      ...
      className={clsx(
        className,
        'fixed inset-x-0 top-0 z-50 flex h-14 items-center justify-between gap-12 px-4 transition-all duration-300 sm:px-6 lg:z-30 lg:px-8',
        isCollapsed ? 'lg:left-16' : 'lg:left-72 xl:left-80',
